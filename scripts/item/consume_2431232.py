...
rewardID = int(random.choice(list(oreNameDict.keys())))


if sm.getEmptyInventorySlots(4) >= 1:
    sm.consumeItem(2431232)
    sm.giveItem(rewardID, oreAmount)
    chr.chatMessage(ChatType.GameDesc,"You have gained items in the Etc tab (" + oreNameDict.get(str(rewardID)) + " " + str(oreAmount) + ")")
